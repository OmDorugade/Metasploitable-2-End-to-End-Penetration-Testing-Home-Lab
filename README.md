...
| 3 | Telnet | Weak Credentials (Brute Force via telnet_login) | Telnet Access | [View](https://github.com/OmDorugade/Metasploitable-2-End-to-End-Penetration-Testing-Home-Lab/blob/main/writeups/ssh.md) |
